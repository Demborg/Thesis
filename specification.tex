...
\label{sec:org23259ee}
\emph{Weeks: 3 and 5-7}

\subsubsection{Goals}
\label{sec:org23f6e63}
\begin{itemize}
...
\label{sec:orgd899de4}
\emph{Weeks: 8-12}


\subsubsection{Goals}
\label{sec:org72cac2f}
\begin{itemize}
...
\label{sec:orgfa3a306}
\emph{Weeks: 13-17}

\subsubsection{Goals}
\label{sec:org1a4dfbc}
\begin{itemize}
\item A working implementation of the project has been created.
\end{itemize}

\subsection{Report}
\label{sec:org28cf1ee}
\emph{Weeks: 18-22}

\subsubsection{Goals}
\label{sec:org4e67ae4}
\begin{itemize}
