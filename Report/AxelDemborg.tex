...
\todo{make sure all the fancy images you add now are actually refed}
...
\begin{figure}[h]
  ...
  \caption{The architecture of \textit{AlexNet}}
  \label{fig:AlexNet}
  \end{figure}
...
\bibentry{boser1992training} on these features.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{R-CNN}
  \caption{The architecture of \textit{R-CNN}}
  \label{fig:R-CNN}
  \end{figure}
...
\begin{figure}[h]
  ...
  \caption{The architecture of \textit{Fast R-CNN}}
  \label{fig:FastR-CNN}
  \end{figure}
...
\begin{figure}[h]
  ...
  \caption{The architecture of \textit{Faster R-CNN}}
  \label{fig:AlexNet}
  \end{figure}
...
\begin{figure}[h]
  ...
  \caption{The architecture of \textit{Mask R-CNN}}
  \label{fig:AlexNet}
  \end{figure}
...
\begin{figure}[h]
  ...
  \caption{The architecture of \textit{SegNet}}
  \label{fig:AlexNet}
  \end{figure}
...
\begin{figure}[h]
  ...
  \caption{\textit{Attention transfer}}
