...
give better accuracy region proposals\todo{Why are they better?} and thus raise overall accuracy in the
...
sections.  
\todo{Explain better but also get accross the idea that the networks are to big/large/deep/heavy}
...
\subsubsection{Attention transfer}
...
\todo{Figure illustrating the different convs etc}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \subcaption{Dilated}
      \end{subfigure}
      \caption{Illustration of the weight matrices used in the different types
        of convolutional operators.}\label{fig:Convs}
\end{figure}
...
\section{Impact}
\todo{Talk about the societal impact and ethical considerations of this work}
