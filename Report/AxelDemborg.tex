...
\alttitle{Realtidssegmentering av fötter på smartphone}
\author{Axel Demborg}
...
\begin{otherlanguage}{swedish}
  \begin{abstract}
    ...
    % bägge dataseten.
    Bildsegmentering, problemet att dela in en bild i meningsfulla bitar och
    semantisk segmentering, problemet att dela upp en bild i flera kända klasser
    är
    mycket intressanta inom datorseende. Segmentering är relevant för allt från
    självkörande bilar till 3D-modellering och syntetiska kamera effekter. Även
    ...
    För att bygga modeller kapabla att göra realtidssegmentering på smartphones
    bygger detta projekt vidare på tidigare arbete på att bygga strömlinjeformade neuronnät och att
    ...
    för mobil 3D-scanning på företaget Volumental.
...
for custom shoe recommendations. The company's current product is a designated
...
%\todo{Add some sort of graph or table detailing the different approaches here}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
      ...
      \end{subfigure}
     \caption{An illustration of softmax using different temperatures, to the
...
% benchmarking tools. From this inference time, and the number of Floating point
...
parallelized this gives an extra discrepancy between FLOPs and actual inference
time.
